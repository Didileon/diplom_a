...
class ServiceCompany(models.Model):
    ...
    user = models.OneToOneField(auth_models.CustomUser, on_delete=models.SET_NULL, verbose_name='Пользователь',  null=True)
...
class Car(models.Model):
    ...
    steering_axle = models.ForeignKey(SteeringAxleModel, on_delete=models.CASCADE, verbose_name="Модель управляемого моста")
...
class Complaint(models.Model):
    ...
    service_company = models.ForeignKey(ServiceCompany, on_delete=models.SET_NULL, verbose_name='Сервисная компания', null=True)
